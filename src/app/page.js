    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="space-y-16">
          {/* First Step */}
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8 bg-white p-6 rounded-lg shadow-lg">
          ...
          {/* Second Step */}
          <div className="flex flex-col md:flex-row-reverse items-center space-y-4 md:space-y-0 md:space-x-8 bg-white p-6 rounded-lg shadow-lg">
            <div className="relative w-full md:w-1/2">
